    ...
    render (data) {
        ...
        M.Tabs.init(tab, {
            ...
            onShow: () => {
                ...
                if (activeTabPosition - scrollXPosition > halfScrollableWidth || scrollXPosition + activeTabPosition > activeTabPosition) {
                    tab.scrollTo({
                        top: 0,
        ...
        const fixBugs = () => {
            document.querySelector('matches-list .tabs-content.carousel.carousel-slider').style.height = 3*window.innerHeight + "px";
        }
        const resize = () => {
